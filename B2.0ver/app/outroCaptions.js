...
export const OUTRO_CAPTIONS=[
  ...
  {start:6.76,end:9.89,text:'房屋的健康，就是您的健康。'},
]
export function outroCaptionAt(time){return OUTRO_CAPTIONS.find(c=>time>=c.start&&time<c.end)?.text|| (time>=9.89 ? OUTRO_CAPTIONS.at(-1).text : '')}
