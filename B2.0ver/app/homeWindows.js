...
export function blindsClosure(seconds){
  const t=((seconds%25)+25)%25
  return T.MathUtils.smoothstep(t,12,15)*(1-T.MathUtils.smoothstep(t,24,25))
}
