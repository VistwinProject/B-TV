...
export default function App() {
  ...
  // 玻璃質感(E 面板可調):setGlass 每次都換新物件 → 這裡的 snapshot 變了才會重繪
  ...
  // 同時把版面切到該情境:五個情境各有自己的欄寬 / 痛點卡高(展演中也生效,非僅編輯模式)
  useEffect(() => {
  ...
  return (
    <div
      ...
      style={accent ? {
        ...
        // 同一組選色的「淺色玻璃」版本(white 版情境牆用;深色版仍吃上面的 --fill-*)
        ...
        // 背景柔光濃度 + 玻璃霧化(CSS 端只留 fallback,實際值由這裡繼承下去)
